...
export const ESSENCE_UPGRADE_ICONS: Record<EssenceUpgradeId, string> = {
  ...
  superShinyChance1: icon('Shiny_Multiplier.png'),
  weakenNegate: icon('Stun_Block_Chance.png'),
  allMaxLoot: icon('Essence.png'),
  damagePctBrittle: icon('Brittle_Essence_Chance.png'),
  superShinyLoot: icon('Shiny_Multiplier.png'),
  ultraCrit1: icon('Archaeology_Crit_Chance.png'),
  critDamageAttackSpeed: icon('Pickaxe_Crit_Chance.png'),
  allMinLoot: icon('Essence.png'),
  allDebuffNegate: icon('Stun_Block_Chance.png'),
  critRespawn: icon('Pickaxe_Crit_Chance.png'),
  superCritDaze: icon('Archaeology_Super_Crit_Chance.png'),
  ultraShiny: icon('Shiny_Essence_Chance.png'),
  allShinyLoot: icon('Shiny_Essence_Multi.png'),
  damagePctArmorPen: icon('Obelisk_Armor_Reduction.png'),
  superCritStun: icon('Stun_Block_Chance.png'),
  flatSuperCrit: icon('Archaeology_Super_Crit_Chance.png'),
  critDamageUltraCrit: icon('Archaeology_Crit_Chance.png'),
  superShinyAttackSpeed: icon('Shiny_Multiplier.png'),
};
...
export const EXCHANGE_UPGRADE_ICONS: Record<ExchangeUpgradeId, string> = {
  ...
  arcanistSpellPower: icon('Spell_Unlock.png'),
};
