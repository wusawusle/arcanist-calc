...
export const BASE_STATS = {
  ...
  /** N16 / v7.1.2. */
  superShinyBonus: 5,
  /** v7.1.2 shiny table: Ultra Shiny adds a further +7 loot. */
  ultraShinyBonus: 7,
...
export const ESSENCE_UPGRADES: EssenceUpgradeDef[] = [
  ...
  { id: 'regenRespawn', row: 25, label: 'Regeneration -1 / Respawn Timer -1s', max: 3, effects: [
      { key: 'regenReduction', label: 'Regeneration', perLevel: 1, display: 'flat' },
      { key: 'respawnReduction', label: 'Respawn Timer', perLevel: -1, display: 'flat' },
    ], note: 'WIP effect is known; cost is not published.' },
  { id: 'superShinyChance1', row: 26, label: 'Super Shiny Chance +0.30%', max: 20, effects: [
      { key: 'superShinyChance', label: 'Super Shiny Chance', perLevel: 0.003, display: 'percent' },
    ], note: 'WIP effect is known; cost is not published.' },
  { id: 'weakenNegate', row: 27, label: 'Flat Damage +1 / Weaken Negate Chance +2%', max: 10, effects: [
      { key: 'flatDamage1', label: 'Flat Damage', perLevel: 1, display: 'flat' },
      { key: 'weakenNegate', label: 'Weaken Negate Chance', perLevel: 0.02, display: 'percent' },
    ], note: 'WIP effect is known; cost is not published.' },
  { id: 'allMaxLoot', row: 28, label: 'All Essence Max Loot +1', max: 2, effects: [
      { key: 'allMaxLoot', label: 'All Essence Max Loot', perLevel: 1, display: 'flat' },
    ], note: 'WIP effect is known; cost is not published.' },
  { id: 'damagePctBrittle', row: 29, label: 'Flat Damage +1.50% / Brittle Chance +0.15%', max: 15, effects: [
      { key: 'damagePct', label: 'Flat Damage', perLevel: 0.015, display: 'percent' },
      { key: 'brittleChance1', label: 'Brittle Chance', perLevel: 0.0015, display: 'percent' },
    ], note: 'WIP effect is known; cost is not published.' },
  { id: 'superShinyLoot', row: 30, label: 'Super Shiny Essence Loot +2', max: 2, effects: [
      { key: 'superShinyLoot', label: 'Super Shiny Essence Loot', perLevel: 2, display: 'flat' },
    ], note: 'WIP effect is known; cost is not published.' },
  { id: 'ultraCrit1', row: 31, label: 'Crit Chance +0.35% / Ultra Crit Chance +0.25%', max: 20, effects: [
      { key: 'critChance1', label: 'Crit Chance', perLevel: 0.0035, display: 'percent' },
      { key: 'ultraCritChance', label: 'Ultra Crit Chance', perLevel: 0.0025, display: 'percent' },
    ], note: 'WIP effect is known; cost is not published.' },
  { id: 'critDamageAttackSpeed', row: 32, label: 'Crit Damage +2% / Attack Speed +0.50%', max: 10, effects: [
  ...
  { id: 'allMinLoot', row: 33, label: 'All Essence Min Loot +1', max: 2, effects: [
      { key: 'allMinLoot', label: 'All Essence Min Loot', perLevel: 1, display: 'flat' },
    ], note: 'WIP effect is known; cost is not published.' },
  { id: 'allDebuffNegate', row: 34, label: 'Flat Damage +2 / All Debuff Negate Chance +0.35%', max: 15, effects: [
      { key: 'flatDamage1', label: 'Flat Damage', perLevel: 2, display: 'flat' },
      { key: 'allDebuffNegate', label: 'All Debuff Negate Chance', perLevel: 0.0035, display: 'percent' },
    ], note: 'WIP effect is known; cost is not published.' },
  { id: 'critRespawn', row: 35, label: 'Crit Chance +4% / Essence Respawn Timer -1s', max: 2, effects: [
      { key: 'critChance1', label: 'Crit Chance', perLevel: 0.04, display: 'percent' },
      { key: 'respawnReduction', label: 'Respawn Timer', perLevel: -1, display: 'flat' },
    ], note: 'WIP effect is known; cost is not published.' },
  { id: 'superCritDaze', row: 36, label: 'Super Crit Damage +3% / Daze Negate Chance +2%', max: 10, effects: [
    ...
    ], note: 'Daze mitigation is tracked; current accessible essence block data does not expose a daze rate.' },
  { id: 'ultraShiny', row: 37, label: 'Shiny Chance +0.30% / Ultra Shiny Chance +0.40%', max: 20, effects: [
      { key: 'shinyChance1', label: 'Shiny Chance', perLevel: 0.003, display: 'percent' },
      { key: 'ultraShinyChance', label: 'Ultra Shiny Chance', perLevel: 0.004, display: 'percent' },
    ], note: 'Ultra Shiny procs only on a Super Shiny.' },
  { id: 'allShinyLoot', row: 38, label: 'All Shiny Essence Loot +1', max: 3, effects: [
      { key: 'allShinyLoot', label: 'All Shiny Essence Loot', perLevel: 1, display: 'flat' },
    ], note: 'Applies to every shiny tier through the base Shiny bonus.' },
  { id: 'damagePctArmorPen', row: 39, label: 'Flat Damage +3% / Essence Armor Pen +2', max: 5, effects: [
  ...
  { id: 'superCritStun', row: 40, label: 'Super Crit Damage +4% / Stun Negate Chance +1.50%', max: 15, effects: [
  ...
  { id: 'flatSuperCrit', row: 41, label: 'Flat Damage +4 / Super Crit Chance +2%', max: 5, effects: [
      { key: 'flatDamage1', label: 'Flat Damage', perLevel: 4, display: 'flat' },
      { key: 'superCritChance1', label: 'Super Crit Chance', perLevel: 0.02, display: 'percent' },
    ], note: 'WIP effect is known; cost is not published.' },
  { id: 'critDamageUltraCrit', row: 42, label: 'Crit Damage +2.50% / Ultra Crit Chance +0.25%', max: 20, effects: [
      { key: 'critDamage', label: 'Crit Damage', perLevel: 0.025, display: 'percent' },
      { key: 'ultraCritChance', label: 'Ultra Crit Chance', perLevel: 0.0025, display: 'percent' },
    ], note: 'WIP effect is known; cost is not published.' },
  { id: 'superShinyAttackSpeed', row: 43, label: 'Super Shiny Chance +0.40% / Attack Speed +0.20%', max: 20, effects: [
...
export const EXCHANGE_UPGRADES: ExchangeUpgradeDef[] = [
  ...
  },
  {
    ...
    id: 'arcanistSpellPower',
    row: 82,
    label: 'Arcanist Spell Power',
    max: 15,
    perLevel: 0.005,
    display: 'percent',
    note: 'WIP: active/passive spell effects +0.5% per level; cost not published.',
  },
];
